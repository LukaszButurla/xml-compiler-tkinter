            ...
            match version:
                ...
                case 1:
                    ...
                    for subject in range(int(amountOfSubjects)):
                        ...
                        price = float(subject[subject.find("<Cena>")+6:subject.find("</Cena>")].replace(",", "."))
                        priceNetto = float(subject[subject.find("<WartoscNetto>")+14:subject.find("</WartoscNetto>")])
                        priceVat = float(subject[subject.find("<WartoscVAT>")+12:subject.find("</WartoscVAT>")])
                        vat = subject[subject.find("<Procent>")+9:subject.find("</Procent>")][1:]
                        amount = float(subject[subject.find("<Ilosc>")+7:subject.find("</Ilosc>")])
                ...
                case 2:
                    ...
                    for subject in range(int(amountOfSubjects)):
                        ...
                        index = subject[subject.find("<Indeks>")+8:subject.find("</Indeks>")]
                        unit = subject[subject.find("<Jednostka>")+11:subject.find("</Jednostka>")]
                        price = float(subject[subject.find("<CenaPLN>")+9:subject.find("</CenaPLN>")].replace(",", "."))
                        priceNetto = float(subject[subject.find("<WartoscNetto>")+14:subject.find("</WartoscNetto>")].replace(",", "."))
                        vat = subject[subject.find("<Procent>")+9:subject.find("</Procent>")][:2]
                        amount = float(subject[subject.find("<Ilosc>")+7:subject.find("</Ilosc>")])

                        vatFloat = vat
                        priceVat = float(priceNetto.replace(",", ".")) * float(vatFloat)
                ...
                case 3:
                    ...
                    for subject in range(int(amountOfSubjects)):
                        ...
                        index = subject[subject.find("<indeks>")+8:subject.find("</indeks>")]
                        unit = subject[subject.find("<jednostka>")+11:subject.find("</jednostka>")]                          
                        price = float(subject[subject.find("<cenaJednPrzedRabatem>")+22:subject.find("</cenaJednPrzedRabatem>")].replace(",", "."))
                        priceNetto = float(subject[subject.find("<kwotaNetto>")+12:subject.find("</kwotaNetto>")].replace(",", "."))
                        priceVat = float(subject[subject.find("<kwotaVAT>")+10:subject.find("</kwotaVAT>")].replace(",", "."))
                        vat = subject[subject.find("<kodVAT>")+10:subject.find("</kodVAT>")]
                        amount = float(subject[subject.find("<ilosc>")+7:subject.find("</ilosc>")].replace(",", "."))
